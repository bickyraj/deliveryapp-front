          ...
          <div className="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-teal-600">
            ...
            <div className="mt-5 overflow-y-auto">
              <nav className="px-2 space-y-1">
                <a href="/" className="group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-md text-white bg-teal-700 focus:outline-none focus:bg-teal-500 transition ease-in-out duration-150">
                  {/* <!-- Heroicon name: home --> */}
                ...
                <a href="/" className="group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-md text-teal-100 hover:text-white hover:bg-teal-500 focus:outline-none focus:bg-teal-500 transition ease-in-out duration-150">
                  {/* <!-- Heroicon name: clock --> */}
                  <svg className="mr-4 h-6 w-6 text-teal-200 transition ease-in-out duration-150" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
